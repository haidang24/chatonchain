	...
	return (
		<div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
			<div className='w-full p-6 rounded-lg shadow-md text-cyan-300 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
				<h1 className='text-3xl font-semibold text-center text-cyan-300'>
					Sign Up
				</h1>
				...
				<form onSubmit={handleSubmit}>
					...
					<div>
						...
						<input
							...
							onChange={(e) => setInputs({ ...inputs, domainName: e.target.value })}
						/>
					</div>
					...
					<div>
						<button className='btn btn-block btn-sm mt-2 border border-slate-800 text-white' disabled={loading}>
